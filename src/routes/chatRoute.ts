...
ChatRouter.get(
  "/public/groups",
  Authentication.jwt,
  chatController.getPublicGroups
);
ChatRouter.get(
  "/public/groups/:query",
  Authentication.jwt,
...
ChatRouter.put(
  "/addusers/:id",
  Authentication.jwt,
  chatController.addUsersToGroup
);
...
ChatRouter.delete(
  "/kickuser/:id/:user",
  Authentication.jwt,
  chatController.kickUserFromGroup
);
...
ChatRouter.get(
  "/verify/ifIsAdmin/:id",
  Authentication.jwt,
  chatController.verifyIsAdmin
);
/**
 * Verificar si  un usuario esta en un grupo de chat
 *
 * @route /v1/chat/verify/inchat/:chat/:user
 * @method get
 */
ChatRouter.get("/verify/inchat/:chat/:user", chatController.usersInChat);
